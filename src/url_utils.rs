...
pub fn extract_urls_from_task(task: &crate::opus::models::Task) -> Vec<UrlWithContext> {
    ...
    if let Some(comments) = &task.comments {
        ...
        for comment in comments {
            let comment_text = comment.content.as_str();
...
mod tests {
    use super::*;
    use crate::opus::models::{Task, Comment, User};
    ...
    fn test_extract_urls_from_task_with_comments() {
        ...
        let comment = Comment {
            ...
            task_id: "1".to_string(),
            user_id: "1".to_string(),
            content: "See https://github.com/project/repo".to_string(),
            user: Some(user),
            created_at: now,
            updated_at: now,
        };
    ...
    fn test_extract_urls_from_task_comment_without_author() {
        ...
        let comment = Comment {
            ...
            task_id: "1".to_string(),
            user_id: "1".to_string(),
            content: "Anonymous comment with https://example.com".to_string(),
            user: None,
            created_at: now,
            updated_at: now,
        };
